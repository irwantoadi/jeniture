...
class KeraliyuActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_keraliyu)

        val edit_text_dropdown: EditText = findViewById(R.id.edit_text_dropdown)
        val list_view: ListView = findViewById(R.id.list_view)
        val array_list = listOf("Gantungan Kunci", "Alat Makan", "Souvenir", "Tempat Sampah", "Mainan Anak")
